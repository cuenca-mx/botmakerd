...
This is a sample template for botmakerd - Below is a brief explanation of what we have generated for you:
...
```bash
aws cloudformation delete-stack --stack-name botmakerd
```
